...
function requirement() {
    ...
    python3.7 -m pip install -r ./requirements/prod.txt -i http://pypi.douban.com/simple --trusted-host pypi.douban.com
}
...
function SystemName() {
    ...
    case $ID in
        centos|fedora|rhel)
            ...
            echo "为了安装更快，建议更换服务器YUM源，更换前做好备份，详情见:https://www.jianshu.com/p/c9084bebd766"
        ...
        debian|ubuntu|devuan)
            ...
            echo "为了安装更快，建议更换服务器APT源，更换前做好备份，详情见:https://www.jianshu.com/p/3cc5ba964f79"
            sudo apt update -y
            sudo apt install -y libmysqld-dev libmysqlclient-dev libpq-dev python3.7-dev 
            ;;
...
function start() {
    ...
    source ./venv/bin/activate
    mkdir -p logs
    nohup python3.7 ${APP} >> logs/runtime.log 2>&1 &
